...
namespace KWSManager
{
    ...
    public class GenericKWSManager<T> : KWSManagerClass where T : IKWSObject, new()
    {
        [Flags]
        ...
        protected virtual bool sceneConfigLoad
        {
            get
            {
        ...
        public static void StaticSetup(GenericKWSManager<T> instance)
        {
