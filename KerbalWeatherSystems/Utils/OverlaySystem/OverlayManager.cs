...
namespace OverlaySystem
{
    ...
    public class Overlay
    {
        ...
        public static Overlay GeneratePlanetOverlay(String planet, float altitude, Material scaledMaterial, Material macroMaterial, Vector2 rotation, bool mainMenu = false, bool matchTerrain = false)
        {
            ...
            Overlay overlay = new Overlay(planet, altitude, scaledMaterial, macroMaterial, Rotation, OverlayManager.MAP_LAYER, celestialTransform, mainMenu, matchTerrain);
            if (!mainMenu)
            {
        ...
        public void UpdateAltitude(bool meshUpdate, float altitude = -1)
        {
            ...
            if (!matchTerrain && meshUpdate)
            {
                ...
                OverlayManager.Log(celestialBody.name + " radius+Altitude: " + Radius);
            }
        }
        ...
        internal void SwitchToScaled()
        {
            ...
            OverlayGameObject.layer = OverlayManager.MAP_LAYER;
            IsScaledSpace = true;
        ...
        internal void SwitchToMacro()
        {
            ...
            OverlayGameObject.layer = OverlayManager.MACRO_LAYER;
            IsScaledSpace = false;
            UpdateAltitude(false);
            if (MacroCallback != null)
            { MacroCallback(true); }
