//Code copied from Rbray's mod EVE, proper credits go to him for such hard work
...
{
    public class AtmosphereObject : MonoBehaviour, IKWSObject
    {
        ...
        public void Apply()
        {
            celestialBody = KWSManagerClass.GetCelestialBody(body);
            scaledCelestialTransform = KWSManagerClass.GetScaledTransform(body);
